package com.module.zy.moduleproject.recycleview;
...
public abstract class BaseLoadMoreHeaderAdapter<T> extends RecyclerView.Adapter {
    ...
    private void init(RecyclerView recyclerView) {        //mRecyclerView添加滑动事件监听
...
//                Log.e("onScrolled",dx+":"+dy);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM) {
            ...
            View progressView = LayoutInflater.from(mContext).inflate(module.base.baseframwork.R.layout.progress_item, parent, false);
